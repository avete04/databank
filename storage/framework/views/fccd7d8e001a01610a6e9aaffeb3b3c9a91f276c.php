...
<script>
    ...
    {
        axios.get(`<?php echo e(route('attachment.get_all')); ?>`).then(res => {
            if(res.data.status == 1)
            {
    ...
    function add_experience()
    {
        ...
        axios.post(`<?php echo e(route('experience.add')); ?>`, data).then(res => {
            if(res.data.status == 1)
            {
                Swal.fire(
                    'Success',
    ...
    {
        axios.get("<?php echo e(route('experience.get_all')); ?>").then(res => {
            if(res.data.status == 1)
            {
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="profile-img-wrap edit-img">
                                            <form id="profile_image_form" method="POST" action="<?php echo e(route('profile_image.update')); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo e(route('attachment.add')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
        <div class="modal-body">
...
<div class="modal fade" id="edit_attachment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo e(route('attachment.update')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
        <div class="modal-body">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/databank/resources/views/profile.blade.php ENDPATH**/ ?>