...
<script>
    ...
    function add_employee()
    {
        ...
        axios.post("<?php echo e(route('employee.create')); ?>", data).then(res => {
    ...
    function delete_employee(id)
    {
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) {
                axios.post("<?php echo e(route('employee.delete')); ?>", data).then(res => {
                    if(res.data.status == 1)
                    {
                        Swal.fire(
                            'Success',
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\avenson\Desktop\databank\resources\views/employees.blade.php ENDPATH**/ ?>