...
let User = [];
    ...
    function add_appraisal()
    {
        ...
        axios.post(`{{route('appraisal.add')}}`, data).then(res => {
    ...
    {
        axios.get(`{{route('appraisal.get_all')}}`).then(res => {
            res.data.forEach(e => {
                console.log(e)
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon"><input class="form-control" value="{{now()->format('Y-m-d')}}" readonly type="text"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="card">
