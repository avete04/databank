...
<script>
    function get_department(e)
    {
        ...
        axios.post("{{route('department.get')}}", data).then(res => {
    ...
    function update_department(id)
    {
        ...
        axios.post("{{route('department.update')}}", data).then(res => {
            if(res.data.status == 1)
            {
                Swal.fire(
                    'Success',
    ...
    function delete_department(id)
    {
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) {
                ...
                axios.post("{{route('department.delete')}}", data).then(res => {
                    if(res.data.status == 1)
                    {
                        Swal.fire(
                            'Deleted!',
                                        ...
                                        <tr>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_department" onclick="get_department({{$department->id}})"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="#" onclick="delete_department({{$department->id}})"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                                </div>
                                            </td>
                                        </tr>
...
function add_department()
{
    ...
    axios.post("{{route('department.create')}}", data).then(res => {
        if(res.data.status == 1)
        {
            Swal.fire(
                'Success',
